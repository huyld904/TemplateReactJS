...
class App extends React.PureComponent {
  ...
  render() {
    ...
    const btnMenu = () => {
      // document.querySelector('.header-mb-menu').addEventListener('cick', function() {
      //   if (document.querySelector('.header-mb-tab').classList.contains('active')) {
      //     {
      //       document.querySelector('.header-mb-tab').classList.remove('active');
      //     }
      //   } else {
      //     document.querySelector('.header-mb-tab').classList.add('active');
      //   }
      // });
      document.querySelector('.header-mb-tab').remove();
    };
      ...
      <div className="App">
        ...
        <div className="header-mb">
          <div className="header-mb-inner">
            ...
            <a className="header-mb-menu active" onClick={this.addActiveClass}>
              <span class="btn_menu">
        ...
        <div className="header-mb-tab active">
