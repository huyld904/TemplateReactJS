...
class App extends React.PureComponent {
  ...
  render() {
    ...
    const btnMenu = () => {
      document.querySelector('.header-mb-menu').removeClass('active');

      // document.querySelector('.header-mb-menu').addEventListener('cick', function() {
      //   if (document.querySelector('.header-mb-tab').hasClass('active')) {
      //     {
      //       document.querySelector('.header-mb-tab').removeClass('active');
      //     }
      //   } else {
      //     document.querySelector('.header-mb-tab').addClass('active');
      //   }
      // });
    };
    return (
