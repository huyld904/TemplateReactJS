                  ...
                  <ul className="other-item">
                    ...
                    <li>
                      <a href="http://m.kenh14.vn" target="_blank" rel="nofollow">
                        ...
                        <span>LinkHay.com</span> <span className="desc">Tin tức dành cho giới trẻ</span>
                      </a>
                    </li>
                    <li>
                      <a href="http://m.kenh14.vn" target="_blank" rel="nofollow">
                        <span className="img avatar-channel soha"></span>
                        <span>Soha.vn</span> <span className="desc">Tin tức dành cho giới trẻ</span>
                      </a>
                    </li>
                    <li>
                      <a href="http://m.kenh14.vn" target="_blank" rel="nofollow">
                        <span className="img avatar-channel afamily"></span>
                        <span>Afamily.vn</span> <span className="desc">Tin tức dành cho giới trẻ</span>
                      </a>
                    </li>
                    <li>
                      <a href="http://m.kenh14.vn" target="_blank" rel="nofollow">
                        <span className="img avatar-channel biz"></span>
                        <span>Cafebiz.vn</span> <span className="desc">Tin tức dành cho giới trẻ</span>
                      </a>
                    </li>
                    <li>
                      <a href="http://m.kenh14.vn" target="_blank" rel="nofollow">
                        <span className="img avatar-channel cafef"></span>
                        <span>CafeF.vn</span> <span className="desc">Tin tức dành cho giới trẻ</span>
                      </a>
                    </li>
                  </ul>
                </div>
