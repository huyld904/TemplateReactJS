...
class App extends React.PureComponent {
  ...
  render() {
    ...
    const btnMenu = () => {
      document.querySelector('.header-mb-tab').classList.toggle('active');
    };
      ...
      <div className="App">
        ...
        <div className="header-mb">
          <div className="header-mb-inner">
            ...
            <a className="header-mb-news" href="https://m.genk.vn/tin-moi.chn">
              <span class="btn_news">
                <i class="icon-header fa-regular fa-file-lines"></i>
              </span>
              <span className="text">Mới</span>
            </a>
            <a className="header-mb-hot" href="https://m.genk.vn/tin-hot.chn">
              <span class="btn_hot">
                <i class="icon-header fa-sharp fa-solid fa-fire"></i>
              </span>
              <span className="text">Hot</span>
            </a>
            <a className="header-mb-menu " onClick={() => btnMenu()}>
              <span class="btn_menu">
                  ...
                  <ul className="other-item">
                    ...
                    <li>
                      <a href="http://m.kenh14.vn" target="_blank" rel="nofollow">
                        ...
                        <span>Soha.vn</span> <span className="desc">Tổng hợp tin</span>
                      </a>
                    </li>
                    <li>
                      <a href="http://m.kenh14.vn" target="_blank" rel="nofollow">
                        <span className="img avatar-channel afamily"></span>
                        <span>Afamily.vn</span> <span className="desc">Chuyên trang gia đình </span>
                      </a>
                    </li>
                    <li>
                      <a href="http://m.kenh14.vn" target="_blank" rel="nofollow">
                        <span className="img avatar-channel biz"></span>
                        <span>Cafebiz.vn</span> <span className="desc">Thông tin kinh doanh - Doanh nhân</span>
                      </a>
                    </li>
                    <li>
                      <a href="http://m.kenh14.vn" target="_blank" rel="nofollow">
                        <span className="img avatar-channel cafef"></span>
                        <span>CafeF.vn</span> <span className="desc">Thông tin kinh tế - tài chính</span>
                      </a>
                    </li>
                  </ul>
                </div>
            ...
            <div className="section-top">
              <div className="news-left">
                <div className="banner-left-box">
                  <a
                    href="https://genk.vn/ho-so-thalidomide-tham-kich-y-te-lon-nhat-trong-lich-su-nhan-loai-20221004134303282.chn"
                    title="Hồ sơ Thalidomide: Thảm kịch y tế lớn nhất trong lịch sử nhân loại"
                    className="thumb"
                  >
                    <img src="https://genk.mediacdn.vn/zoom/540_336/139269124445442048/2022/10/4/avatar1664865014303-1664865025613971591135.png" />
                  </a>
                  <div className="left-box-title">
                    <h2>
                      <a
                        ...
                        title="Hồ sơ Thalidomide: Thảm kịch y tế lớn nhất trong lịch sử nhân loại"
                      >
                        Hồ sơ Thalidomide: Thảm kịch y tế lớn nhất trong lịch sử nhân loại
                      </a>
                    </h2>
                  </div>
                </div>
                <ul className="news-left-list">
                  <li>
                    <div className="news-left-list-box">
                      <a
                        href="/tai-sao-facebook-google-hay-tiktok-luon-co-giau-thong-tin-quang-cao-tren-nen-tang-cua-minh-20221008095128536.chn"
                        title="Tại sao Facebook, Google hay Tiktok luôn cố giấu thông tin quảng cáo trên nền tảng của mình"
                        className="thumb"
                      >
                        <img src="https://genk.mediacdn.vn/zoom/260_162/139269124445442048/2022/10/8/avatar1665197343908-16651973445361563670758.jpg" />
                      </a>
                      <div className="news-left-list-title">
                        <h3>
                          <a
                            href="/tai-sao-facebook-google-hay-tiktok-luon-co-giau-thong-tin-quang-cao-tren-nen-tang-cua-minh-20221008095128536.chn"
                            title="Tại sao Facebook, Google hay Tiktok luôn cố giấu thông tin quảng cáo trên nền tảng của mình"
                            class="gknews_title"
                          >
                            Tại sao Facebook, Google hay Tiktok luôn cố giấu thông tin quảng cáo trên nền tảng của mình
                          </a>
                        </h3>
                      </div>
                    </div>
                  ...
                  <li>
                    <div className="news-left-list-box">
                      <a
                        ...
                        className="thumb"
                      >
                        <img src="https://genk.mediacdn.vn/zoom/260_162/139269124445442048/2022/10/8/avatar1665201971061-1665201971453233844872.jpg" />
                      </a>
                      <div className="news-left-list-title">
                        <h3>
                          <a
              ...
              <div className="news-right">
                <div className="news-right-flex">
                  <div className="bigright-left">
                    <div className="bigright-left-box">
                      <a
                        href="/nghien-cuu-moi-cho-thay-cho-soi-thuc-su-co-the-hinh-thanh-su-gan-bo-voi-con-nguoi-tuong-tu-nhu-loai-cho-2022100720021041.chn"
                        title="Nghiên cứu mới cho thấy chó sói thực sự có thể hình thành sự gắn bó với con người tương tự như loài chó"
                        className="thumb"
                      >
                        <img src="https://genk.mediacdn.vn/zoom/260_162/139269124445442048/2022/10/7/avatar1665147563267-1665147564181556351695.jpg" />
                      </a>
                      <div className="bigright-left-box-title">
                        <h3>
                          <a
                            href="/nghien-cuu-moi-cho-thay-cho-soi-thuc-su-co-the-hinh-thanh-su-gan-bo-voi-con-nguoi-tuong-tu-nhu-loai-cho-2022100720021041.chn"
                            title="Nghiên cứu mới cho thấy chó sói thực sự có thể hình thành sự gắn bó với con người tương tự như loài chó"
                            class="gknews_title"
                          >
                            Nghiên cứu mới cho thấy chó sói thực sự có thể hình thành sự gắn bó với con người tương tự
                            như loài chó
                          </a>
                        </h3>
                      </div>
                    </div>
                    <ul className="bigright-left-list">
                      <li>
                        <div className="list-box">
                          <a
                            href="/sieu-trai-dat-bao-quan-su-song-lau-hon-trai-dat-gioi-khoa-hoc-tim-thay-dieu-bat-ngo-20221008114853289.chn"
                            title="Siêu Trái Đất 'bảo quản' sự sống lâu hơn Trái Đất: Giới khoa học tìm thấy điều bất ngờ!"
                            className="thumb"
                          >
                            <img src="https://genk.mediacdn.vn/zoom/80_50/139269124445442048/2022/10/8/avatar1665204095690-16652040961281130432369.jpg" />
                          </a>
                          <div className="list-box-title">
                            <h3>
                              <a
                                ...
                                class="gknews_title"
                              >
                                Siêu Trái Đất 'bảo quản' sự sống lâu hơn Trái Đất: Giới khoa học tìm thấy điều bất ngờ!
                              </a>
                            </h3>
                          </div>
                        </div>
                      ...
                      <li>
                        <div className="list-box">
                          <a
                            ...
                            class="thumb"
                          >
                            <img src="https://genk.mediacdn.vn/zoom/80_50/139269124445442048/2022/10/7/avatar1665109719338-1665109719736226219140.jpg" />
                          </a>
                          <div className="list-box-title">
                            <h3>
                              <a
                      ...
                      <li>
                        <div className="list-box">
                          <a
                            ...
                            class="thumb"
                          >
                            <img src="https://genk.mediacdn.vn/zoom/80_50/139269124445442048/2022/10/7/avatar1665136132718-1665136132999668049814.jpg" />
                          </a>
                          <div className="list-box-title">
                            <h3>
                              <a
                      ...
                      <li>
                        <div className="list-box">
                          <a
                            ...
                            class="thumb"
                          >
                            <img src="https://genk.mediacdn.vn/zoom/80_50/139269124445442048/2022/10/8/avatar1665197627715-16651976278991633066519.jpg" />
                          </a>
                          <div className="list-box-title">
                            <h3>
                              <a
                  ...
                  <div className="bigright-right"></div>
                </div>
              </div>
            </div>
          </div>
